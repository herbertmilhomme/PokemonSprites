        ...
        static void Main(string[] args)
        {
            ...
            while (PokemonCounter < MaxPoke + 1)
            {
                ...
                if (Pokemon.HiddenAbility == "" || Pokemon.HiddenAbility == null)
                {
                    ...
                    Pokemon.HiddenAbility = Pokemon.HiddenAbility.Replace(' ', '_').Replace('-', '_').ToUpper();
                }
                Console.Write("+");
